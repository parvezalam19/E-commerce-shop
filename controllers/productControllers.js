...
export const createProductController = async (req, res) => {
  try {
    // here we are using req.files bcz we have added the formidable in routes
...
export const productFiltersController = async (req, res) => {
  try {
    ...
    if (selectedPriceRange.length > 0) args.price = { $gte: selectedPriceRange[0], $lte: selectedPriceRange[1] };
